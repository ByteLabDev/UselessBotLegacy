...
readfile = open(r"Logs/log"+StrC+".log","r")
...
class ScrollBar: 
    ...
    def __init__(self): 
        ...
        root.iconbitmap("Images/UselessBot.ico")
        root.title("UselessBot - Log "+str(TotalC))
        ...
        t = Text(root, width = 50, height = 15, wrap = NONE, 
                 xscrollcommand = h.set,  
                 yscrollcommand = v.set) 
   
        # insert some text into the text widget 
        for i in range(20): 
            t.insert(END,readfile.read())
